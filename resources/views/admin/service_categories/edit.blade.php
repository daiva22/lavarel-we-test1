...
<head>
    <meta charset="UTF-8">
    <title>Edit Service Main Title - AutoTech</title>
...
<div class="main">
    ...
    <form method="POST" action="{{ route('admin.service-categories.update', $category->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        @if($category->image)
            <div style="margin-top:10px; margin-bottom:20px;">
                ...
                <img src="{{ asset($category->image) }}" alt="{{ $category->name }}" style="width:120px; height:120px; object-fit:cover; border-radius:8px; border:1px solid #ddd;">
            </div>
        @endif
        ...
        <div style="margin-top:20px; display:flex; gap:10px;">
            <button type="submit" class="btn-approve">Update Main Title</button>
